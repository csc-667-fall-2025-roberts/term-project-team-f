...
const q = { type: "error", data: "parser error" },
  ...
  ee = typeof ArrayBuffer == "function",
  te = (n) =>
  ...
  M = ({ type: n, data: e }, t, s) =>
    Z && e instanceof Blob
      ? t
        ? s(e)
        : Y(e, s)
      : ee && (e instanceof ArrayBuffer || te(e))
        ? t
          ? s(e)
          : Y(new Blob([e]), s)
        : s(y[n] + (e || "")),
...
let x;
function ye(n, e) {
  if (Z && n.data instanceof Blob) return n.data.arrayBuffer().then(z).then(e);
  if (ee && (n.data instanceof ArrayBuffer || te(n.data))) return e(z(n.data));
  M(n, !1, (t) => {
...
for (let n = 0; n < J.length; n++) E[J.charCodeAt(n)] = n;
const me = (n) => {
    let e = n.length * 0.75,
      t = n.length,
      s,
    ...
    for (s = 0; s < t; s += 4)
      ((r = E[n.charCodeAt(s)]),
        (o = E[n.charCodeAt(s + 1)]),
        (c = E[n.charCodeAt(s + 2)]),
        (h = E[n.charCodeAt(s + 3)]),
        (f[i++] = (r << 2) | (o >> 4)),
        (f[i++] = ((o & 15) << 4) | (c >> 2)),
        (f[i++] = ((c & 3) << 6) | (h & 63)));
    return m;
  ...
  H = (n, e) => {
    if (typeof n != "string") return { type: "message", data: se(n, e) };
    const t = n.charAt(0);
    return t === "b"
      ? { type: "message", data: _e(n.substring(1), e) }
      : A[t]
        ? n.length > 1
          ? { type: A[t], data: n.substring(1) }
          : { type: A[t] }
        : q;
  },
  _e = (n, e) => {
    ...
    transform(o, c) {
      for (t.push(o); ; ) {
        if (s === 0) {
          ...
          if (k(t) < 2) break;
          const h = T(t, 2);
          ((i = new DataView(h.buffer, h.byteOffset, h.length).getUint16(0)),
            (s = 3));
        } else if (s === 2) {
          if (k(t) < 8) break;
          const h = T(t, 8),
          ...
          if (k(t) < i) break;
          const h = T(t, i);
          (c.enqueue(H(r ? h : N.decode(h), e)), (s = 0));
        }
        if (i === 0 || i > n) {
          c.enqueue(q);
          break;
...
function ke(n) {
  for (var e in u.prototype) n[e] = u.prototype[e];
  return n;
}
...
const Ae = l.setTimeout,
  Re = l.clearTimeout;
function B(n, e) {
  e.useNativeTimers
    ? ((n.setTimeoutFn = Ae.bind(l)), (n.clearTimeoutFn = Re.bind(l)))
    : ((n.setTimeoutFn = l.setTimeout.bind(l)),
      (n.clearTimeoutFn = l.clearTimeout.bind(l)));
}
const Oe = 1.33;
function Se(n) {
  return typeof n == "string"
    ? Ce(n)
    : Math.ceil((n.byteLength || n.size) * Oe);
}
function Ce(n) {
  let e = 0,
    t = 0;
...
class $ extends u {
  ...
  onError(e, t, s) {
    return (super.emitReserved("error", new Ne(e, t, s)), this);
  }
  open() {
...
class Le extends $ {
  ...
  onData(e) {
    ...
    (we(e, this.socket.binaryType).forEach(t),
...
function ce(n) {
  const e = n.xdomain;
  try {
    if (typeof XMLHttpRequest < "u" && (!e || qe)) return new XMLHttpRequest();
  } catch {}
  if (!e)
    try {
...
class Fe extends $ {
  ...
  uri() {
    const e = this.opts.secure ? "wss" : "ws",
      t = this.query || {};
    return (
      this.opts.timestampRequests && (t[this.opts.timestampParam] = oe()),
...
class Ve extends Fe {
  createSocket(e, t, s) {
    return he ? new L(e, t, s) : t ? new L(e, t) : new L(e);
  }
  doWrite(e, t) {
    this.ws.send(t);
  }
    ...
    (this._transport.closed
      ...
      this._transport.ready.then(() => {
        this._transport.createBidirectionalStream().then((e) => {
          const t = Ee(Number.MAX_SAFE_INTEGER, this.socket.binaryType),
...
const He = { websocket: Ve, webtransport: Me, polling: Ue },
  $e =
  ...
  return (
    t != -1 &&
      ...
      (r.authority = r.authority
        ...
        .replace(/;/g, ":")),
      (r.ipv6uri = !0)),
    (r.pathNames = We(r, r.path)),
    (r.queryKey = Ye(r, r.query)),
    r
  );
}
function We(n, e) {
...
class _ extends u {
  constructor(e, t) {
    ...
    (B(this, t),
      ...
      typeof this.opts.query == "string" &&
        (this.opts.query = xe(this.opts.query)),
      D &&
  ...
  createTransport(e) {
    ...
    ((t.EIO = ie), (t.transport = e), this.id && (t.sid = this.id));
...
function Xe(n, e = "", t) {
  ...
  ((t = t || (typeof location < "u" && location)),
    ...
    typeof n == "string" &&
      (n.charAt(0) === "/" &&
        (n.charAt(1) === "/" ? (n = t.protocol + n) : (n = t.host + n)),
      /^(https?|wss?):\/\//.test(n) ||
...
const Qe = typeof ArrayBuffer == "function",
  Ge = (n) =>
    typeof ArrayBuffer.isView == "function"
      ? ArrayBuffer.isView(n)
  ...
  je =
    typeof Blob == "function" ||
    (typeof Blob < "u" && ue.call(Blob) === "[object BlobConstructor]"),
  Ze =
    typeof File == "function" ||
    (typeof File < "u" && ue.call(File) === "[object FileConstructor]");
function K(n) {
  return (
    (Qe && (n instanceof ArrayBuffer || Ge(n))) ||
    (je && n instanceof Blob) ||
    (Ze && n instanceof File)
  );
}
function O(n, e) {
  if (!n || typeof n != "object") return !1;
  if (Array.isArray(n)) {
    for (let t = 0, s = n.length; t < s; t++) if (O(n[t])) return !0;
    return !1;
  }
  if (K(n)) return !0;
  if (n.toJSON && typeof n.toJSON == "function" && arguments.length === 1)
    return O(n.toJSON(), !0);
  for (const t in n)
    if (Object.prototype.hasOwnProperty.call(n, t) && O(n[t])) return !0;
  return !1;
}
function et(n) {
  const e = [],
...
function I(n, e) {
  ...
  if (K(n)) {
    ...
    for (let s = 0; s < n.length; s++) t[s] = I(n[s], e);
    return t;
...
function U(n, e) {
  ...
  if (n && n._placeholder === !0) {
    ...
    for (let t = 0; t < n.length; t++) n[t] = U(n[t], e);
    ...
    switch (e) {
      ...
      case a.BINARY_EVENT:
        return (
          Array.isArray(t) &&
          (typeof t[0] == "number" ||
            (typeof t[0] == "string" && st.indexOf(t[0]) === -1))
        );
      case a.ACK:
      case a.BINARY_ACK:
  ...
  socket(e, t) {
    ...
    return (
      s
        ...
        : ((s = new fe(this, e, t)), (this.nsps[e] = s)),
      s
    );
  }
  _destroy(e) {
...
function S(n, e) {
  ...
  let h;
  return (
    c ? (h = new F(s, e)) : (v[i] || (v[i] = new F(s, e)), (h = v[i])),
    t.query && !e.query && (e.query = t.queryKey),
    h.socket(t.path, e)
  );
}
Object.assign(S, { Manager: F, Socket: fe, io: S, connect: S });
const G = (n = 0) => `chat:${n}:message`,
  j = (n = 0) => `chat:${n}:listing`,
  le = S(),
  ct = document.querySelector("#message-listing"),
  V = document.querySelector("#messsage-submit input"),
  ht = document.querySelector("#message-submit button"),
  pe = (n) => {
    const e = document.createElement("div");
    ((e.innerText = n), ct.appendChild(e));
  };
le.on(j(), ({ messages: n }) => {
  n.forEach((e) => {
    (console.log(j, e), pe(`${e.username} (${e.created_at}): ${e.message}`));
  });
});
le.on(G(), (n) => {
  (console.log(G(), n), pe(`${n.username} (${n.created_at}): ${n.message}`));
});
const de = () => {
  const n = V.value.trim(),
    e = JSON.stringify({ message: n });
  (n.length > 0 &&
    fetch("/chat/", {
      method: "post",
      body: e,
...
ht.addEventListener("click", (n) => {
  (n.preventDefault(), de());
});
V.addEventListener("keydown", (n) => {
  n.key ===
    `
` && de();
});
